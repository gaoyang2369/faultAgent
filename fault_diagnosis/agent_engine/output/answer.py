...
from ...diagnosis.contracts import AnalysisStepArtifact, EvidenceBundle, ReportStepArtifact, SqlStepArtifact
...
def _render_answer(
    *,
    ...
    if variant == "diagnosis_answer" and analysis_artifact:
