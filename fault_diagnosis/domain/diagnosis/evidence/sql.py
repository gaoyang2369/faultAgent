"""SQL-result evidence construction for diagnosis runtimes."""
...
from fault_diagnosis.domain.diagnosis.contracts import DiagnosisRequest, EvidenceItem, EvidenceQuality, SqlStepArtifact
