...
from fault_diagnosis.platform.paths import PDFS_DIR
from fault_diagnosis.platform.settings import KB_QUERY_TIMEOUT_SECONDS
...
def query_knowledge_base(query: str) -> str:
    ...
    try:
        ...
        from fault_diagnosis.platform.knowledge.base import get_knowledge_retriever, has_knowledge_base_index
        ...
        try:
            from fault_diagnosis.platform.knowledge.uploaded_file_kb import (
