...
ANSWER_MODEL_REQUEST_TIMEOUT_SECONDS = max(0.1, float(os.getenv("ANSWER_MODEL_REQUEST_TIMEOUT_SECONDS", "15")))
...
ANSWER_SYNTHESIS_MAX_INPUT_CHARS = max(1000, int(os.getenv("ANSWER_SYNTHESIS_MAX_INPUT_CHARS", "6000")))
