...
ANSWER_SYNTHESIS_TIMEOUT_SECONDS = max(0.1, float(os.getenv("ANSWER_SYNTHESIS_TIMEOUT_SECONDS", "20")))
...
ANSWER_SYNTHESIS_MAX_OUTPUT_TOKENS = max(64, int(os.getenv("ANSWER_SYNTHESIS_MAX_OUTPUT_TOKENS", "1000")))
ANSWER_SYNTHESIS_TEMPERATURE = min(0.1, max(0.0, float(os.getenv("ANSWER_SYNTHESIS_TEMPERATURE", "0.0"))))
ANSWER_SYNTHESIS_MAX_CONCURRENCY = max(1, int(os.getenv("ANSWER_SYNTHESIS_MAX_CONCURRENCY", "8")))
