...
from fault_diagnosis.server.agent_gateway.error_classification import classify_model_gateway_error, model_error_code
...
async def _check_mysql(timeout_seconds: float, deep: bool) -> dict[str, Any]:
    ...
    async def probe():
        from fault_diagnosis.platform.database.db_pool import get_pool
...
def _check_faiss(deep: bool) -> dict[str, Any]:
    from fault_diagnosis.platform.knowledge.base import get_knowledge_base_status
...
def _check_document_ocr() -> dict[str, Any]:
    try:
        from fault_diagnosis.platform.integrations.document_ocr_runtime import get_document_ocr_status
...
def _check_uploaded_file_kb() -> dict[str, Any]:
    from fault_diagnosis.platform.knowledge.uploaded_file_kb import get_uploaded_file_kb_status, has_uploaded_file_corpus, has_uploaded_file_index
...
def _check_diagnosis_artifact_store() -> dict[str, Any]:
    try:
        from fault_diagnosis.platform.persistence.diagnosis_artifacts.store import check_artifact_store_health
...
def _check_governance_repository() -> dict[str, Any]:
    try:
        from fault_diagnosis.platform.persistence.repositories.governance_repository import FileGovernanceRepository
...
def _check_admin_file_registry() -> dict[str, Any]:
    try:
        from fault_diagnosis.platform.persistence.repositories.admin_file_repository import get_admin_file_repository
