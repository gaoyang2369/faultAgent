...
from fault_diagnosis.server.devtools.dev_mode import get_dev_messages, get_dev_todos_payload, list_dev_threads
from fault_diagnosis.platform.logging import get_logger
from fault_diagnosis.platform.persistence.repositories.conversation_store import get_conversation_repository, messages_to_history_payload
from fault_diagnosis.platform.persistence.repositories.history_index import get_history_index_repository
from fault_diagnosis.shared.utils import sanitize_chat_history_messages, summarize_identifier_for_log
...
class HistoryService:
    ...
    def _clear_thread_artifact(self, history_type: str, thread_id: str) -> None:
        try:
            from fault_diagnosis.platform.persistence.diagnosis_artifacts.store import clear_thread_artifact
